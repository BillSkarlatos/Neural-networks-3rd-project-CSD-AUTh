...
class RBFNetwork(nn.Module):
    def __init__(self, input_dim, hidden_neurons, num_classes, centers_init, beta_val):
...
def RBF():
    ...
    model = RBFNetwork(input_dim=train_data.shape[1], hidden_neurons=hidden_neurons, num_classes=num_classes, centers_init=centers_init, beta_val=beta_val)
    ...
    print(f"Accuracy with Radial Basis Function Neural Network: {accuracy * 100:.2f}%")
